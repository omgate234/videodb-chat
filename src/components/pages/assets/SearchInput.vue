  ...
  >
    ...
    >
      <li
        ...
        class="vdb-c-flex vdb-c-w-full vdb-c-items-center vdb-c-gap-10 vdb-c-overflow-x-hidden vdb-c-rounded-8 vdb-c-bg-white vdb-c-px-10 vdb-c-py-8 vdb-c-text-[13px] vdb-c-leading-[24px] vdb-c-text-black"
      >
        No result found
      </li>
      <li
