...
const updatePosition = () => {
  console.log(
    '>>>',
    props.collection.id,
    document.querySelector(`[data-collection-id="${props.collection.id}"]`)
  );
  if (document.querySelector(`[data-collection-id="${props.collection.id}"]`)) {
    try {
      const rect = document
        .querySelector(`[data-collection-id="${props.collection.id}"]`)
