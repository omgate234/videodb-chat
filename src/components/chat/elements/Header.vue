<template>
  <div class="vdb-c-z-[1000] vdb-c-py-16 md:vdb-c-py-24">
    ...
    >
      ...
      >
        ...
        <Button
          ...
          variant="tertiary"
          class="vdb-c-flex-none !vdb-c-px-8 !vdb-c-py-8 md:!vdb-c-px-8 md:!vdb-c-py-10"
        >
          <div
    ...
    <div
      v-else
      class="vdb-c-inline-block vdb-c-h-[2rem] vdb-c-w-full vdb-c-animate-pulse vdb-c-rounded vdb-c-bg-roy md:vdb-c-h-[2.5rem]"
    ></div>
  </div>
</template>
...
const headerMainText = computed(
  () => props.headerConfig.headerText || props.collectionName || null,
);
</script>
