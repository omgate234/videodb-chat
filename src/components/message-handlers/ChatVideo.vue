    ...
    <transition name="fade" mode="out-in">
      ...
      >
        ...
        >
          ...
          <div
            :class="
              isFullScreen
                ? 'vdb-c-fixed vdb-c-inset-0 vdb-c-z-50 vdb-c-flex vdb-c-h-full vdb-c-w-full vdb-c-flex-col vdb-c-items-center vdb-c-justify-center vdb-c-overflow-y-hidden vdb-c-bg-black-64'
                : hasEditor
                  ? 'vdb-c-h-[170px] vdb-c-w-full vdb-c-overflow-hidden vdb-c-rounded-20'
                  : 'vdb-c-w-full'
            "
          >
            <VideoDBPlayer
          ...
          >
            <button
              class="vdb-c-flex vdb-c-items-center vdb-c-justify-center vdb-c-rounded-full vdb-c-bg-[#F7F7F7] vdb-c-p-[5px] vdb-c-text-[#242424]"
            >
              <svg
...
watch(
  ...
  (thumbnails) => {
    console.log("ChatVideo: thumbnails", thumbnails);
  },
  { immediate: true },
);
